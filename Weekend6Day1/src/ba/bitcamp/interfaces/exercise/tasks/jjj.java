 ...
 * <ul>
 * <li>Constants that indicate the clock format available
...
interface WriteableClock {
	...
	/**
	 * <p>
	 * Method that should convert the clock's attributes into the wanted format
	 * and then should call the <code>writeToFile(String, String)</code> method
	 * in order to write the clock into a file.
	 * <p>
	 * This method should be only called from the <code>main</code> method.
	 * 
	 * @param filename
	 *            Path to the file in which the clock will be written to
	 * @param format
	 *            One of the type constants, ex. <code>MILITARY_TIME</code>
	 */
	void addToFile(String filename, int format);

	/**
	 * <b>Adds</b> the given time into a file. Ukoliko nemate JAVA 1.8, nego
	 * neku stariju verziju onda prekopirajte ovu metodu u svoju klasu i stavite
	 * da je private umjesto default.
	 * 
	 * @param filename
	 *            Path to the file
	 * @param time
	 *            <code>String</code> which will be written
	 */
