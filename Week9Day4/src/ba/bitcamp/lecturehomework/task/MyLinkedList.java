package ba.bitcamp.lecturehomework.task;
...
public class MyLinkedList implements Iterable<Double> {
	 ...
	 */
	public MyLinkedList(MyLinkedList doubleLinked) {
	...
	public Iterator<Double> iterator() {
		...
		return new MyNewIterator<Double>();
	}

	public class MyNewIterator<Doublet> implements Iterator<Double> {
		...
		public MyNewIterator() {
			...
			this.status = MyLinkedList.this.start;
		...
		public Double next() {
			...
			if (current == null) {
                current = MyLinkedList.this.start;
	...
	public static void main(String[] args) {
		...
		Iterator<Double> x = list.iterator();
