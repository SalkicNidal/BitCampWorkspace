...
public class TryYelllowPlayer extends JFrame {
	...
	public TryYelllowPlayer() throws IOException {
		...
		// Set image of player piun :D

		image = ImageIO.read(new File("yellow.png"));
		label[10][0].setIcon(new ImageIcon(image));
		label[9][0].setIcon(new ImageIcon(image));
		label[9][1].setIcon(new ImageIcon(image));
		label[10][1].setIcon(new ImageIcon(image));
