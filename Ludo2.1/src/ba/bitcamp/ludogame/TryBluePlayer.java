...
public class TryBluePlayer extends JFrame {
	...
	public TryBluePlayer() throws IOException {
		...
		label[9][9].setIcon(new ImageIcon(image));
		label[9][10].setIcon(new ImageIcon(image));
		label[10][10].setIcon(new ImageIcon(image));
		label[10][9].setIcon(new ImageIcon(image));
