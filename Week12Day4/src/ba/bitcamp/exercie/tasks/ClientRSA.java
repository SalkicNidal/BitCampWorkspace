...
public class ClientRSA {
	...
	public static void main(String[] args) {
		...
		try {
			while (true) {
				...
				// getAllPrimes(new BigInteger(msg.split(" ")[0]), new
				// BigInteger(msg.split(" ")[1]), new
				// BigInteger(msg.split(" ")[2]));
		...
		// getAllPrimes(new BigInteger("10"), new
		// BigInteger("31176236472038964811"));
	}
	...
	public static BigInteger getAllPrimes(BigInteger start, BigInteger end,
			BigInteger big) {
